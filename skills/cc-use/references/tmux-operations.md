...
Instead of polling for idle state, use `.cc-use/cc watch` which compares screen snapshots:
...
- For full conversation history, use `.cc-use/cc read_conversation` to parse JSONL transcripts in `~/.claude/projects/`
